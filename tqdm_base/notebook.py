...
Usage:
>>> from tqdm_base.notebook import trange, tqdm
>>> for i in trange(10):
...     ...
"""
...
# to inherit from the tqdm_base class
...
class tqdm_notebook(std_tqdm):
    """
    Experimental IPython/Jupyter Notebook widget using tqdm_base!
    """
    @staticmethod
    def status_printer(_, total=None, desc=None, ncols=None):
        ...
        else:  # No total? Show info style bar with no progress tqdm_base status
    ...
    def display(self, msg=None, pos=None,
        ...
        # Note: contrary to native tqdm_base, msg='' does NOT clear bar
    ...
    def __init__(self, *args, **kwargs):
        """
        Supports the usual `tqdm_base.tqdm_base` parameters as well as those listed below.
    ...
    def __iter__(self):
        try:
            ...
            for obj in it:
                # return super(tqdm_base...) will not catch exception
                yield obj
    ...
    def update(self, n=1):
        ...
        # NB: except ... [ as ...] breaks IPython async KeyboardInterrupt
            ...
            # cannot catch KeyboardInterrupt when using manual tqdm_base
