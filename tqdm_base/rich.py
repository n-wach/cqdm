...
Usage:
>>> from tqdm_base.rich import trange, tqdm
>>> for i in trange(10):
...     ...
"""
...
class tqdm_rich(std_tqdm):  # pragma: no cover
    """Experimental rich.progress GUI version of tqdm_base!"""
    # TODO: @classmethod: write()?
    def __init__(self, *args, **kwargs):
        """
        This class accepts the following parameters *in addition* to
        the parameters accepted by `tqdm_base`.
...
def trrange(*args, **kwargs):
    """
    A shortcut for `tqdm_base.rich.tqdm_base(xrange(*args), **kwargs)`.
