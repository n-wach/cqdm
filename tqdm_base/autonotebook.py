...
Usage:
>>> from tqdm_base.autonotebook import trange, tqdm
>>> for i in trange(10):
...     ...
"""
import sys
...
try:
    ...
    warn("Using `tqdm_base.autonotebook.tqdm_base` in notebook mode."
         " Use `tqdm_base.tqdm_base` instead to force console mode"
