...
Usage:
>>> from tqdm_base.asyncio import trange, tqdm
...
class tqdm_asyncio(std_tqdm):
    """
    Asynchronous-friendly version of tqdm_base (Python 3.6+).
    """
...
def tarange(*args, **kwargs):
    """
    A shortcut for `tqdm_base.asyncio.tqdm_base(range(*args), **kwargs)`.
    """
