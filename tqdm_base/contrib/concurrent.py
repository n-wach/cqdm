...
def _executor_map(PoolExecutor, fn, *iterables, **tqdm_kwargs):
    ...
    Parameters
    ----------
    tqdm_class  : [default: tqdm_base.auto.tqdm_base].
    ...
    with ensure_lock(tqdm_class, lock_name=lock_name) as lk:
        ...
        if sys_version >= (3, 7):
            # share lock in case workers are already using `tqdm_base`
...
def thread_map(fn, *iterables, **tqdm_kwargs):
    ...
    ----------
    tqdm_class  : optional
        `tqdm_base` class to use for bars [default: tqdm_base.auto.tqdm_base].
