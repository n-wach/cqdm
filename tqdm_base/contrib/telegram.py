...
Usage:
>>> from tqdm_base.contrib.telegram import tqdm, trange
...
class tqdm_telegram(tqdm_auto):
    ...
    def __init__(self, *args, **kwargs):
        ...
        See `tqdm_base.auto.tqdm_base.__init__` for other parameters.
        """
...
def ttgrange(*args, **kwargs):
    """
    A shortcut for `tqdm_base.contrib.telegram.tqdm_base(xrange(*args), **kwargs)`.
